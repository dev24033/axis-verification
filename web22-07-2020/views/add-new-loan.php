...
<body>
   ...
   <div class="tab-pane active" role="tabpanel" id="step1">
	  ...
	  <form action="#" id="step_one_form_data" enctype="multipart/form-data">
        ...
        <!--  <p style="text-align:left;font-size:18px;font-weight:bold;">Comments: 
         ...
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <div class="col-md-4">
                  <input type="radio" class="form-control" name="tele_contacted" id="tele_contacted" value="Yes">
                  <label>Yes</label>
                  <br>
               </div>
               <div class="col-md-5">
         ...
         <div class="row">
            <div class="col-md-6">
               <div class="form-group"> <span class="control-label col-sm-5" for="visit_date"> Date of Visit : <span class="danger">*</span>
                              ...
                              <input type="date" class="form-control required setdatePicarDsp"  id="coa_date_of_visit" name="coa_date_of_visit" style="height:37px;"> 
                           </span>
               </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
               <div class="form-group"> <span class="control-label col-sm-5" for="applicant_name">Product: <span class="danger">*</span> </span> <span class="col-sm-7">
                              <input type="text"  class="form-control required"  name="coa_product" id="coa_product" value="Home Loan" > 
                           </span>
               </div>
            </div>
            <div class="col-md-6">
        ...
        <!--  <p style="text-align:left;font-size:18px;font-weight:bold;">Comments: 
         ...
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <div class="col-md-4">
                  <input type="radio" class="form-control" name="coa_tele_contacted" id="coa_tele_contacted" value="Yes" >
                  <label>Yes</label>
                  <br>
               </div>
               <div class="col-md-5">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group"> <span class="control-label col-sm-5" for="visit_date"> Date of Visit : <span class="danger">*</span>
                                       ...
                                       <input type="date" class="form-control required setdatePicarDsp"  id="coa_off_dof_visit" name="coa_off_dof_visit" style="height:37px;"> 
                                    </span>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group"> <span class="control-label col-sm-5" for="visit_time"> Time of Visit : <span class="danger">*</span>
                                       ...
                                       <input type="time" class="form-control required" id="coa_off_tof_visit" name="coa_off_tof_visit" style="height:37px;"> 
                                    </span>
                        </div>
                     </div>
                     <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                           <input type="radio" class="form-control" name="coa_business_activity" id="coa_business_activity" value="Ease">
                           <label>Easy</label>
                           <br>
                        </div>
                        <div class="col-md-3">
                           <input type="radio" class="form-control" name="coa_business_activity" id="coa_business_activity" value="Difficult">
                           <label>Difficult</label>
                           <br>
                        </div>
                        <div class="col-md-3">
                           <input type="radio" class="form-control" name="coa_business_activity" id="coa_business_activity" value="Untraceable">
                           <label>Untraceable</label>
                           <br>
                        </div>
                     </div>
                     <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                           <input type="text" class="form-control" name="coa_applicant_availed" id="coa_applicant_availed">
                           <br>
                        </div>
                     </div>
                     <div class="col-md-12">
