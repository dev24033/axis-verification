            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dd">
               ...
               <tr>
				  ...
				  <td align="left" valign="top">Yes
                     <label class="sp_container">
                        <input type="checkbox" value="yes" <?php echo ($applicant_office[0]['tele_contacted'] == 'Yes' ? 'checked' : ''); ?> > <span class="sp_checkmark"></span>
                     </label> 
                  </td>
				  <td align="left" valign="top">No
                     <label class="sp_container">
                        <input type="checkbox" value="yes" <?php echo ($applicant_office[0]['tele_contacted'] == 'No' ? 'checked' : ''); ?> > <span class="sp_checkmark"></span>
                     </label> 
                  </td>
         ...
         <div class="table-responsive">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dd" >
               ...
               <tr>
                  ...
                  <td align="left" valign="top" colspan="3"><?php echo $rapplicant_office[0]['business_sighted']; ?></td>
               </tr>
               <tr>
