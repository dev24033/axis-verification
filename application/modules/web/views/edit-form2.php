		...
		<input type="hidden" name="applicant_id" id="applicant_id" value="<?php echo $applicant_id[0]['application_id']; ?>"/>
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <input type="date" class="form-control required setdatePicarDsp" required id="off_dof_visit" name="off_dof_visit" style="height:37px;" value="<?php echo $applicant_office[0]['off_dof_visit']; ?>">  
                                    </span>
                        </div>
                     </div>
                     <div class="col-md-6">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                           <input type="radio" class="form-control" name="business_activity" id="business_activity" value="High" <?php echo ($applicant_office[0]['business_activity'] == 'High' ? 'checked' : ''); ?>>
                           <label>High</label>
                           <br>
                        </div>
                        <div class="col-md-3">
                           <input type="radio" class="form-control" name="business_activity" id="business_activity" value="Medium" <?php echo ($applicant_office[0]['business_activity'] == 'Medium' ? 'checked' : ''); ?>>
                           <label>Medium</label>
                           <br>
                        </div>
                        <div class="col-md-3">
                           <input type="radio" class="form-control" name="business_activity" id="business_activity" value="Low" <?php echo ($applicant_office[0]['business_activity'] == 'Low' ? 'checked' : ''); ?>>
                           <label>Low</label>
                           <br>
                        </div>
                     </div>
                     <div class="col-md-12">
						...
						<div class="col-md-4">
						<input type="radio" class="form-control" name="applicant_availed" id="applicant_availed" value="Yes" <?php echo ($applicant_office[0]['applicant_availed'] =='Yes' ? 'checked' : ''); ?> >
						<label>Yes</label>
						<br>
						</div>
						<div class="col-md-5">
						<input type="radio" class="form-control" name="applicant_availed" id="applicant_availed" value="No" <?php echo ($applicant_office[0]['applicant_availed'] =='No' ? 'checked' : ''); ?> >
						<label>No</label>
						<br>
						</div>
         ...
         <h4 class="text-center"><b>Co-Applicant Form</b></h4>
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                           <input type="radio" class="form-control" name="coa_business_activity" id="coa_business_activity" value="High" <?php echo ($co_applicant_office[0]['coa_business_activity']=='High' ? 'checked' : ''); ?>>
                           <label>High</label>
                           <br>
                        </div>
                        <div class="col-md-3">
                           <input type="radio" class="form-control" name="coa_business_activity" id="coa_business_activity" value="Medium" <?php echo ($co_applicant_office[0]['coa_business_activity']=='Medium' ? 'checked' : ''); ?>>
                           <label>Medium</label>
                           <br>
                        </div>
                        <div class="col-md-3">
                           <input type="radio" class="form-control" name="coa_business_activity" id="coa_business_activity" value="Low" <?php echo ($co_applicant_office[0]['coa_business_activity']=='Low' ? 'checked' : ''); ?>>
                           <label>Low</label>
                           <br>
                        </div>
                     </div>
                     <div class="col-md-12">
						...
						<div class="col-md-4">
						<input type="radio" class="form-control" name="coa_applicant_availed" id="coa_applicant_availed" value="Yes" <?php echo ($co_applicant_office[0]['coa_applicant_availed'] =='Yes' ? 'checked' : ''); ?> >
						<label>Yes</label>
						<br>
						</div>
						<div class="col-md-5">
						<input type="radio" class="form-control" name="coa_applicant_availed" id="coa_applicant_availed" value="No" <?php echo ($co_applicant_office[0]['coa_applicant_availed'] =='No' ? 'checked' : ''); ?> >
						<label>No</label>
						<br>
						</div>
