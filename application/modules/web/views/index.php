        ...
        <h2>Login</h2>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="uname" required id="uname" class="form-control" >
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="name">Password</label>
                        <input type="password" required name="loginpassword"  id="loginpassword" class="form-control">
                    </div>
                </div>
            ...
            <div class="row" style="margin-top: 20px;">
                <div class="col-md-12 text-center">
                   <!--<button type="button" class="btn btn-primary btn-block" value="Login" ></button> -->
