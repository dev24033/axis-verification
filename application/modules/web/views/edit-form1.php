         ...
         <div class="row">
            <div class="col-md-6">
               <div class="form-group"> <span class="control-label col-sm-5" for="visit_date"> Date of Visit : <span class="danger">*</span>
                              ...
                              <input type="date" class="form-control required setdatePicarDsp" required id="date_of_visit" name="date_of_visit" style="height:37px;" value="<?php echo $row['date_of_visit']; ?>"> 
                           </span>
               </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-12">
             ...
             <div class="col-md-12">
               ...
               <div class="col-md-2">
                  <input type="radio" class="form-control" name="locating" id="locating" value="Easy"  <?php echo ($row['locating'] == 'Easy' ? 'checked' : ''); ?> >
                  <label>Easy </label>
                  <br>
               </div>
               <div class="col-md-3">
                  <input type="radio" class="form-control" name="locating" id="locating" value="Difficult" <?php echo ($row['locating'] == 'Difficult' ? 'checked' : ''); ?> >
                  <label>Difficult</label>
                  <br>
               </div>
               <div class="col-md-4">
                  <input type="radio" class="form-control" name="locating" id="locating" value="Untraceable" <?php echo ($row['locating'] == 'Untraceable' ? 'checked' : ''); ?> >
            ...
            <div class="col-md-12">
               ...
               <div class="col-md-2">
                  <input type="radio" class="form-control" name="resi_covid_z" id="resi_covid_z" value="Red" <?php echo ($row['resi_covid_z']=='Red' ? 'checked' : '');?> >
                  <label>Red</label>
                  <br>
               </div>
               <div class="col-md-3">
                  <input type="radio" class="form-control" name="resi_covid_z" id="resi_covid_z" value="Amber" <?php echo ($row['resi_covid_z']=='Amber' ? 'checked' : '');?> >
                  <label>Amber</label>
                  <br>
               </div>
               <div class="col-md-4">
                  <input type="radio" class="form-control" name="resi_covid_z" id="resi_covid_z" value="Green" <?php echo ($row['resi_covid_z']=='Green' ? 'checked' : '');?> >
                  <label>Green</label>
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-2">
                  <input type="radio" class="form-control" name="family_mem_inf" id="family_mem_inf" value="No Infection" <?php echo ($row['family_mem_inf']=='No Infection' ? 'checked' : '');?>  >
                  <label>No Infection</label>
                  <br>
               </div>
               <div class="col-md-3">
                  <input type="radio" class="form-control" name="family_mem_inf" id="family_mem_inf" value="Infected And Treated" <?php echo ($row['family_mem_inf']=='Infected And Treated' ? 'checked' : '');?> >
                  <label>Infected And Treated</label>
                  <br>
               </div>
               <div class="col-md-4">
                  <input type="radio" class="form-control" name="family_mem_inf" id="family_mem_inf" value="Death Happened in the family due to COVID" <?php echo ($row['family_mem_inf']=='Death Happened in the family due to COVID' ? 'checked' : '');?> >
	...
	<?php foreach($applicant_tele as $row) 	{ ?>
         ...
         <div class="row">
            <div class="col-md-6">
               <div class="form-group"> <span class="control-label col-sm-5" for="visit_date"> Date of Calling : <span class="danger">*</span></span> <span class="col-sm-7"> 
                 <input type="date" class="form-control required setdatePicarDsp" required id="tele_dof_visit" name="tele_dof_visit" style="height:37px;" value="<?php echo $row['tele_dof_visit']; ?>" > 
                                                                     </span>
               </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" required name="tele_nof_app" id="tele_nof_app" value="<?php echo $row['tele_nof_app']; ?>">
                  <br>
               </div>
            </div>
         </div>
         ...
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <div class="col-md-4">
                  <input type="radio" class="form-control" name="tele_contacted" id="tele_contacted" value="Yes" <?php echo ($row['tele_contacted'] =='Yes' ? 'checked' : ''); ?> >
                  <label>Yes</label>
                  <br>
               </div>
               <div class="col-md-5">
                  <input type="radio" class="form-control" name="tele_contacted" id="tele_contacted" value="No" <?php echo ($row['tele_contacted'] =='No' ? 'checked' : ''); ?> >
                  <label>No</label>
                  <br>
               </div>
            </div>
       ...
       <section class="applicant-form" id="co-applicant">
         ...
         <div class="row">
            <div class="col-md-6">
               <div class="form-group"> <span class="control-label col-sm-5" for="visit_date"> Date of Visit : <span class="danger">*</span>
                              ...
                              <input type="date" class="form-control required setdatePicarDsp" id="coa_date_of_visit" name="coa_date_of_visit"  style="height:37px;" value="<?php echo $co_applicant[0]['coa_date_of_visit']; ?>" > 
                           </span>
               </div>
            </div>
            <div class="col-md-6">
               <div class="form-group"> <span class="control-label col-sm-5" for="visit_time"> Time of Calling : <span class="danger">*</span>
                  </span> <span class="col-sm-7"> 
                              <input type="time" class="form-control required" name="coa_date_of_time" id="coa_date_of_time"  style="height:37px;"value="<?php echo $co_applicant[0]['coa_date_of_time']; ?>" > 
                           </span>
               </div>
            </div>
            <div class="col-md-6">
               <div class="form-group"> <span class="control-label col-sm-5" for="applicant_name">Product: <span class="danger">*</span> </span> <span class="col-sm-7">
                              <input type="text"  class="form-control required" name="coa_product" id="coa_product"  value="<?php echo $co_applicant[0]['coa_product']; ?>" > 
                           </span>
               </div>
            </div>
            <div class="col-md-6">
               <div class="form-group"> <span class="control-label col-sm-5" for="email">File No : <span class="danger">*</span> </span> <span class="col-sm-7">
                              <input type="text" class="form-control required" id="coa_file_no" name="coa_file_no"  value="<?php echo $co_applicant[0]['coa_file_no']; ?>" >
                           </span>
					</div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_address" id="coa_address" value="<?php echo $co_applicant[0]['coa_address']; ?>" >
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_person_met" id="coa_person_met" value="<?php echo $co_applicant[0]['coa_person_met']; ?>">
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_rel_with_app" id="coa_rel_with_app" value="<?php echo $co_applicant[0]['coa_rel_with_app']; ?>">
                  <br>
               </div>
            </div>
             <div class="col-md-12">
               ...
               <div class="col-md-2">
                  <input type="radio" class="form-control" name="coa_locating" id="coa_locating" value="Ease" <?php echo ($co_applicant[0]['coa_locating'] == 'Easy' ? 'checked' : ''); ?>>
                  <label>Easy </label>
                  <br>
               </div>
               <div class="col-md-3">
                  <input type="radio" class="form-control" name="coa_locating" id="coa_locating" value="Difficult" <?php echo ($co_applicant[0]['coa_locating'] == 'Difficult' ? 'checked' : ''); ?>>
                  <label>Difficult</label>
                  <br>
               </div>
               <div class="col-md-4">
                  <input type="radio" class="form-control" name="coa_locating" id="coa_locating" value="Untraceable" <?php echo ($co_applicant[0]['coa_locating'] == 'Untraceable' ? 'checked' : ''); ?>>
                  <label>Untraceable</label>
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_landmark" id="coa_landmark" value="<?php echo $co_applicant[0]['coa_landmark']; ?>" >
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_residence" id="coa_residence" value="<?php echo $co_applicant[0]['coa_residence']; ?>" >
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_years_staying" id="coa_years_staying" value="<?php echo $co_applicant[0]['coa_years_staying']; ?>" >
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_stay_con_by" id="coa_stay_con_by" value="<?php echo $co_applicant[0]['coa_stay_con_by']; ?>">
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_type_of_resi" id="coa_type_of_resi" value="<?php echo $co_applicant[0]['coa_type_of_resi']; ?>" >
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-2">
                  <input type="radio" class="form-control" name="coa_resi_covid_z" id="coa_resi_covid_z" value="Red" <?php echo ($co_applicant[0]['coa_resi_covid_z'] == 'Red' ? 'checked' : ''); ?>>
                  <label>Red</label>
                  <br>
               </div>
               <div class="col-md-3">
                  <input type="radio" class="form-control" name="coa_resi_covid_z" id="coa_resi_covid_z" value="Amber" <?php echo ($co_applicant[0]['coa_resi_covid_z'] == 'Amber' ? 'checked' : ''); ?> >
                  <label>Amber</label>
                  <br>
               </div>
               <div class="col-md-4">
                  <input type="radio" class="form-control" name="coa_resi_covid_z" id="coa_resi_covid_z" value="Green" <?php echo ($co_applicant[0]['coa_resi_covid_z'] == 'Green' ? 'checked' : ''); ?>>
                  <label>Green</label>
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-2">
                  <input type="radio" class="form-control" name="coa_family_mem_inf" id="coa_family_mem_inf" value="No Infection" <?php echo ($co_applicant[0]['coa_family_mem_inf'] == 'No Infection' ? 'checked' : ''); ?> > 
                  <label>No Infection</label>
                  <br>
               </div>
               <div class="col-md-3">
                  <input type="radio" class="form-control" name="coa_family_mem_inf" id="coa_family_mem_inf" value="Infected And Treated" <?php echo ($co_applicant[0]['coa_family_mem_inf'] == 'Infected And Treated' ? 'checked' : ''); ?>   >
                  <label>Infected And Treated</label>
                  <br>
               </div>
               <div class="col-md-4">
                  <input type="radio" class="form-control" name="coa_family_mem_inf" id="coa_family_mem_inf" value="Death Happened in the family due to COVID" <?php echo ($co_applicant[0]['coa_family_mem_inf'] == 'Death Happened in the family due to COVID' ? 'checked' : ''); ?>  >
                  <label>Death Happened in the family due to COVID</label>
                  <br>
               </div>
            </div>
         ...
         <div class="row">
           <div class="col-md-12">
               ...
               <div class="col-md-9">
                <textarea rows="3" class="form-control" placeholder="" name="coa_comments" id="coa_comments"> <?php echo $co_applicant[0]['coa_comments']; ?> </textarea>
        ...
        <!--  <p style="text-align:left;font-size:18px;font-weight:bold;">Comments: 
         ...
         <div class="row">
            <div class="col-md-6">
               <div class="form-group"> <span class="control-label col-sm-5" for="visit_date"> Date of Visit : <span class="danger">*</span></span> <span class="col-sm-7"> 
                                                                     <input type="date" class="form-control required setdatePicarDsp"  id="coa_tele_dof_visit" name="coa_tele_dof_visit"  style="height:37px;" value="<?php echo $co_applicant_tele[0]['coa_tele_dof_visit']; ?>" > 
                                                                     </span>
               </div>
            </div>
            <div class="col-md-6">
               <div class="form-group"> <span class="control-label col-sm-5" for="visit_time"> Time of Visit : <span class="danger">*</span></span> <span class="col-sm-7"> 
                                                                     <input type="time" class="form-control required" id="coa_tele_tof_visit" name="coa_tele_tof_visit"  style="height:37px;" value="<?php echo $co_applicant_tele[0]['coa_tele_tof_visit']; ?>" > 
                                                                     </span>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_tele_nof_app" id="coa_tele_nof_app" value="<?php echo $co_applicant_tele[0]['coa_tele_nof_app']; ?>">
                  <br>
               </div>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_tele_cont_no" id="coa_tele_cont_no" value="<?php echo $co_applicant_tele[0]['coa_tele_cont_no']; ?>">
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-4">
                  <input type="radio" class="form-control" name="coa_tele_contacted" id="coa_tele_contacted" value="Yes" <?php echo ($co_applicant_tele[0]['coa_tele_contacted'] == 'Yes' ? 'checked' : ''); ?> >
                  <label>Yes</label>
                  <br>
               </div>
               <div class="col-md-5">
                  <input type="radio" class="form-control" name="coa_tele_contacted" id="coa_tele_contacted" value="No" <?php echo ($co_applicant_tele[0]['coa_tele_contacted'] == 'No' ? 'checked' : ''); ?> >
                  <label>No</label>
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_tele_spoken" id="coa_tele_spoken" value="<?php echo $co_applicant_tele[0]['coa_tele_spoken']; ?>">
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_tele_rel_w_app" id="coa_tele_rel_w_app" value="<?php echo $co_applicant_tele[0]['coa_tele_rel_w_app']; ?>">
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_tele_years_staying" id="coa_tele_years_staying" value="<?php echo $co_applicant_tele[0]['coa_tele_years_staying']; ?>">
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_tele_residence" id="coa_tele_residence" value="<?php echo $co_applicant_tele[0]['coa_tele_residence']; ?>">
                  <br>
               </div>
            </div>
            <div class="col-md-12">
               ...
               <div class="col-md-9">
                  <input type="text" class="form-control" name="coa_tele_alt_cont_no" id="coa_tele_alt_cont_no" value="<?php echo $co_applicant_tele[0]['coa_tele_alt_cont_no']; ?>" >
                  <br>
               </div>
            </div>
